...
class Main(Frame):
    ...
    def set_option(self, name):
        ...
        self.add_logo.grid(row=5, column=0, padx=70)
    ...
    def set_search(self, name):
        ...
        self.column_answer.grid(row=2, column=1, padx=10, pady=10)
